...
public class Enemigo3Uno : MonoBehaviour
{    
 ...
 if(distToPlayer <= range)
 {
    canShoot = true;
        ...
        gameObject.GetComponent <Animator>().SetBool("caminar", true);
         gameObject.GetComponent <Animator>().SetBool("dispararquieto", false);
         }
       ...
       // m_rig.velocity = Vector2.zero;
        ...
        gameObject.GetComponent <Animator>().SetBool("dispararquieto", true);
      //  gameObject.GetComponent <Animator>().SetBool("caminar", false);
