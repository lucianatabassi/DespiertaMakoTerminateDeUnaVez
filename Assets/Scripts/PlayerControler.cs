...
public class PlayerControler : MonoBehaviour
{
   ...
   if (Input.GetKey("d") && Input.GetKey("space") ) {  //
    ...
    if (Input.GetKey("s") && !Input.GetKey("a") && !Input.GetKey("d") ) // agacharse
    {
    ...
    if(Input.GetKey("mouse 0") && disparando || (Input.GetKey("f") && disparando)) 
    {
        Disparar();
  ...
  /*  if (Input.GetKey("mouse 0")) { //dispara con el mouse
    ...
    if (Input.GetKeyDown ("mouse 0") && disparando || Time.time >= timestamp && (Input.GetKey("f") && disparando)) { //dispara con el mouse
